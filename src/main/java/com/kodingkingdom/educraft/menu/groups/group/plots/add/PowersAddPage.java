	...
	protected void compositeAttachedAction(Connector connector){
		...
		PowersAddContentPage contentPage = new PowersAddContentPage(
				...
				, new SelectItem(
						...
						, Icon.makeIcon(Texture.Portal).withName("Create LocationTeleportPower on your current location")
				...
				, new SelectItem(
						...
						, Icon.makeIcon(Texture.Teleport).withName("Create PlayerTeleportPower on a player")

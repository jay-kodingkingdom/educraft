...
public class AllGroupsContentPage extends SelectFunctionSortedAllPage<Group>{

	public AllGroupsContentPage(Consumer<Group> GroupAction, Supplier<ItemStack> GroupIcon) {
		super(
			()->{
